...
import { calculateDifficulty, calculateDifficultyEx, calculateDifficultyEx2 } from "./difficultyAlgorithm";
...
const runJob = async () => {
    ...
    if (appData !== undefined) {
        ...
        console.log(`Keyword: ${KEYWORDS}, Country: ${countries[COUNTRY_CODE]}, Difficulty: ${difficulty}`)
        console.log(`Ex - Keyword: ${KEYWORDS}, Country: ${countries[COUNTRY_CODE]}, Difficulty: ${difficultyEx}`)
        console.log(`Ex2 - Keyword: ${KEYWORDS}, Country: ${countries[COUNTRY_CODE]}, Difficulty: ${difficultyEx2}`)
    } else {
